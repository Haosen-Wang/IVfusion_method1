...
parser.add_argument('--epochs', type=int, default=5, help='maximum number of epochs to train the total model.')
...
parser.add_argument('--data_file_dir', type=str, default='/home/user/whs/IVfusion_method1/experiments/TG-ECNet/stage2/data_dir/',  help='path of txt for training set')
parser.add_argument('--denoise15_dir', type=str, default='/home/user/whs/1024whs_data/DeMMI-RF/Train/degrad/noise15/',
                    help='where clean images of denoising saves.')
parser.add_argument('--denoise25_dir', type=str, default='/home/user/whs/1024whs_data/DeMMI-RF/Train/degrad/noise25/',
                    help='where clean images of denoising saves.')
parser.add_argument('--denoise50_dir', type=str, default='/home/user/whs/1024whs_data/DeMMI-RF/Train/degrad/noise50/',
                    help='where clean images of denoising saves.')
parser.add_argument('--defocusdeblur_dir', type=str, default='/home/user/whs/1024whs_data/DeMMI-RF/Train/degrad/DefocusBlur/',
                    help='where clean images of debluring saves.')
parser.add_argument('--dehaze_dir', type=str, default='/home/user/whs/1024whs_data/DeMMI-RF/Train/degrad/haze/',
                    help='where training images of dehazing saves.')
parser.add_argument('--stripe_dir', type=str, default='/home/user/whs/1024whs_data/DeMMI-RF/Train/degrad/Stripe/',
